...
// render :ListPage
var listPage = document.querySelector('.content-number-page');
...
// render products
var products = document.querySelector('.product__bottom');
...
function renderProduct() {
  ...
  for (const i = (currentPage - 1) * perPage; i < perPage * currentPage; i++) {
    products.innerHTML += `
    <div class="product-items">
               <div class="product-item-name">
               <a href="homePageDetail.html"><img style="object-fit:cover;" src="${mockData[i].image}" alt="" /></a>
                 <h4>
                   ${mockData[i].name}
                 </h4>
